...
@Component({
    selector: 'add-detail-model-component',
    templateUrl: './add-detail-model.components.html',
    styleUrls: ['./add-detail-model.components.css'],
    providers: [ModelControllerService, ModelColorControllerService, PurchaseOrdenControllerService]
})
export class AddDetailModelComponent {
