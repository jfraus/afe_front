...
export class Hj2Service {
  ...
  createHj2ByInvoice(invoice: String, sendFile: Boolean){
    return this.http.get<any>(`${environment.apiUrl}hj2/create-hj2-by-invoice?invoice=${invoice}&sendFile=${sendFile}`);
  }
